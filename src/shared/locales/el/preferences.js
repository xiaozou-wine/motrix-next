export default {
  ...
  'proxy-unsupported-protocol':
    'Μη υποστηριζόμενο πρωτόκολλο proxy. Το aria2 υποστηρίζει μόνο HTTP proxy (http/https/ftp).',
  ...
  'proxy-system-socks-rejected':
    'Ο διακομιστής μεσολάβησης συστήματος χρησιμοποιεί πρωτόκολλο SOCKS, μη υποστηριζόμενο από aria2',
